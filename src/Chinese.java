...
public class Chinese
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("x % a_i = b_i，求x:");
        System.out.print("输入a1 , a2 , a3：");
        m[0]=input.nextBigInteger();
        m[1]=input.nextBigInteger();
        m[2]=input.nextBigInteger();

        System.out.print("输入b1 , b2 , b3：");
        ...
        if(a[0].equals(BigInteger.valueOf(0))
            ...
            System.out.println("方程没有唯一解，方程组的解为"+m[0]+" ,"+m[1]+" ,"+m[2]+" "+"的公倍数");
            return;
        }
        ...
        for(int i=0;i<k;i++) {
            CRTSet y=new CRTSet();
            CRTSet x=new CRTSet();
            inverse(M.divide(m[i]),m[i],x,y);//求逆元
            e[i]=x.v;
        }
